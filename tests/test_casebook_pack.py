"""Regression checks for the helix-sec-policy-vault casebook."""
...
from casebook.harness import assert_expected, helix_sec_policy_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(helix_sec_policy_vault_summary(), assert_expected())
